...
export function optionsPanel(specsState, vehicle) {
  ...
  return `<section class="np-specs glass">
    <div class="np-section-head">
      ...
      <button class="np-btn np-btn-ghost np-btn-sm" data-action="toggle-sticker">
        ${specsState.showSticker ? "Hide window sticker" : "View window sticker"}
      </button>
    </div>
    ...
    ${specsState.showSticker ? `<div class="np-sticker-wrap">${windowSticker(s, vehicle)}</div>` : ""}
  </section>`;
}
